...
from common.libs.Helper import select_filter_from_obj, get_dict_by_field, get_current_time
...
def myOrderInfo():
    ...
    pay_order_info = PayOrder.query.filter_by(
        member_id=member_info.id, order_sn=order_sn).first()
...
def myCommentList():
    ...
    if comment_list:
        ...
        pay_order_map = get_dict_by_field(
            PayOrder, PayOrder.id, "id", pay_order_ids)
